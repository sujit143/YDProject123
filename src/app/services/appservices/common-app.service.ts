...
export class CommonAppService {
  ...
  constructor(private httpService: CommonHttpService, private LocalStorageService: LocalStorageService,
    ...
    this.api_url = appSettings.API_ENDPOINT;
  ...
  public detechBrowserCompatibility() {
    ...
    var message = `The browser version being used is not supported.  You can continue using ZoomTeams, but please be aware that there are features which may
    ...
    switch (objbrowserName) {
      ...
      case "Edge":
        ...
        break;
      default:
        message = `The browser being used is not supported.  You can continue using ZoomTeams,
